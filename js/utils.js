...
/**
 * Detects the LV type abbreviation from its name using pattern matching.
 * @param {string} name - Name of the LV or group
 ...
 * derived from the LV name (falling back to the group name).
 * @param {Object} mod - Module object containing a `color` property
 * @param {string} lvName - Name of the LV
...
/**
 * Checks whether an LV name indicates optional attendance (HÜ / GÜ).
 * Used by the optimizer to classify "free" days.
 * @param {string} name - LV or group name
 * @returns {boolean} True if the LV is considered optional
 */
